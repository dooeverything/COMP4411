...
inline void ModelerUserInterface::cb_m_controlsAnimOnMenu_i(Fl_Menu_*, void*) {
  //ModelerApplication::Instance()->m_animating = (m_controlsAnimOnMenu->value() == 0) ? false : true;
	...
	}else if(ModelerApplication::Instance()->m_animating == true){
...
inline void ModelerUserInterface::cb_Frame_All_i(Fl_Menu_*, void*) {
	m_modelerView->m_camera->framAll();
	m_modelerView->redraw();
}
...
Fl_Menu_Item ModelerUserInterface::menu_m_controlsMenuBar[] = {
 ...
 {"Animate", 0, (Fl_Callback*)ModelerUserInterface::cb_m_controlsAnimOnMenu, 0, 2, 0, 0, 14, 0},
 {0},
 //{"Animate", 0,  0, 0, 64, 0, 0, 14, 0},
 //{"Enable", 0,  (Fl_Callback*)ModelerUserInterface::cb_m_controlsAnimOnMenu, 0, 0, 0, 0, 14, 0},
 {0},
 {0}
};
